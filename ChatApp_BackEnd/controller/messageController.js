...
const { archiveOldMessages, deleteArchiveMessages } = require("../Services/messageArchieveService");
...
exports.sendMessage = async (req, res) => {
  try {
    ...
    //calling the archive message service here
    await archiveOldMessages(channelId);

    res.status(201).json({
      message: newMessage,
      links: {
        self: `/api/messages/channels/{messageId}/messages`,
  ...
  try {
    ...
    res.json({
      ...
      links: {
        ...
        archivedMessages: `/api/archive/archived-messages/{channelId}`,
        channelMessages: `/api/messages/channels/{channelId}/messages`,
        clearChannelMessages: "/api/messages/channels/{channelId}/messages",
      },
    });
  } catch (error) {
...
exports.deleteMessages = async (req, res) => {
  try {
    ...
    res.status(200).json({
      ...
      links: {
        allMessages: `/api/channels/channels/{channelId}/messages`,
        channelMessages: `/api/messages/channels/{channelId}/messages`,
      },
    });
  } catch (error) {
...
exports.clearChannelMessages = async (req, res) => {
  try {
    ...
    await deleteArchiveMessages(channelId);
